...
<div class="btn-group" role="group" aria-label="..."  style="margin-left:-16px" >
  <button type="button" class="btn btn-default" onclick="changeCategeryAll('PM2.5')"><a>PM<sub>2.5<sub></a></button>
  <button type="button" class="btn btn-default" onclick="changeCategeryAll('PM10')"><a>PM<sub>10<sub></a></button>
  <button type="button" class="btn btn-default" onclick="changeCategeryAll('SO2')"><a>SO<sub>2<sub></a></button>
  <button type="button" class="btn btn-default" onclick="changeCategeryAll('NO2')"><a>NO<sub>2<sub></a></button>
  <button type="button" class="btn btn-default" onclick="changeCategeryAll('CO')"><a>CO</a></button>
  <button type="button" class="btn btn-default" onclick="changeCategeryAll('O3')"><a>O<sub>3<sub></a></button>
</div>
        	...
        	$container.html(contentHTML);
        		...
        		$container.find("button").click(function(){
        			...
        			if(buttonType == 'provinces'){    //  點擊省份事件
        				...
        				$('#currentCategoryShow').html(selectorValue)
