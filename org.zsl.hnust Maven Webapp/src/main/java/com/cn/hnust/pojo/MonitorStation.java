...
public class MonitorStation {
	...
	public String toString() {
		return "MonitorStation [aqi=" + aqi + ", area=" + area + ", co=" + co + ", co_24h=" + co_24h + ", no2=" + no2
				+ ", no2_24h=" + no2_24h + ", o3=" + o3 + ", o3_24h=" + o3_24h + ", o3_8h=" + o3_8h + ", o3_8h_24h="
				+ o3_8h_24h + ", pm10=" + pm10 + ", pm10_24h=" + pm10_24h + ", pm2_5=" + pm2_5 + ", pm2_5_24h="
				+ pm2_5_24h + ", position_name=" + position_name + ", primary_pollutant=" + primary_pollutant
				+ ", quality=" + quality + ", so2=" + so2 + ", so2_24h=" + so2_24h + ", station_code=" + station_code
